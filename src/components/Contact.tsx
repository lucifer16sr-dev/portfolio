  ...
  const contactInfo = [
    {
      icon: "📧",
      title: "Email",
      content: "bright.king.ming@gmail.com",
      link: "mailto:bright.king.ming@gmail.com",
    },
    {
      icon: "📱",
      title: "Phone",
      content: "+1 (810) 692-0109",
      link: "tel:+1 (810) 692-0109",
    },
    {
      icon: "📍",
      title: "Location",
      content: "POTEET, TX, USA",
      link: "#",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-blue-600 hover:text-white transition-colors duration-200"
                  aria-label="GitHub"
                >
                  <svg
                    className="w-6 h-6"
